...
5: Add "@Inject IBlazorLocalizer Loc" to any components where you need localization.
	...
	Category:	The category for the text you're translating. This category could be the same for all localized keys on the same page. If left null or empty, BlazorLocalizer will use the fullname of the class where the text is being invoked.
	...
	-- Examples for usage within codebloc:
		string localizedKey = Loc.L("Key goes here");
